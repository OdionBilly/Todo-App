...
// object funcion for adding to the form
  ...
  return ( 
      ...
      <div className={`${darkTheme ? "bg-slate-900"  : " bg-[#f2f2f2]" } min-h-screen pb-20 relative`} >
        <div className="bg-light_header_image_mobile lg:bg-light_header_image bg-no-repeat bg-cover h-52 px-5 lg:px-0 pt-10" style={{backgroundImage : `url(${Background})`}}>
